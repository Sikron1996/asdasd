...
async function disconnectWallet(){
  ...
  wcProvider=null; provider=null; signer=null; contract=null; account=null; cachedPriceWei=null; cachedAlreadyMinted=0n;
  walletEl.textContent="not connected"; status("Disconnected"); await refreshPrice();
}
...
document.getElementById("browserWalletBtn").onclick = connectBrowserWallet;
document.getElementById("walletConnectBtn").onclick = connectWalletConnect;
